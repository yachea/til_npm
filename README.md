...
- 2단계 : css 를 뽑아내기 (제공되는 css 원본활용)
- /src/pages/calendar.css 파일 생성
- 원본 소스를 그대로 복사 붙여넣고 수정함.
...
function Schedule() {
  ...
  const formatShortWeekday = (lacale, date) => {
